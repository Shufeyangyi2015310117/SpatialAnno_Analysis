...
for (iter in 1:50){
  ...
  save(res1, res2, file = paste0("/nas/yangyi2/Xingjie/simulation/simulation141_splatter_data", iter, ".RData"))
  ...
  save(acc, f1s, kappa, err, time, file = "/nas/yangyi2/Xingjie/simulation/simulation141_splatter_method1-3.RData")

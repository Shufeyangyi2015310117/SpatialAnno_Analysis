...
save(err, acc, f1s,kappa, time, fit_s2, rho,  pos, y, file = "embryo1_allcelltype_unknown_8markers_scSorter_initial_icmem_lfc=_8marker_presomitic_8m_Gut_adjusted.RData")

...
########################################################################################################################
# 2. plot  Figure 2b, Supplementary Figure 3b
library(BayesSpace)
library(ggplot2)
library(dplyr)
library(ggsci)
...
# RGB plot in Figure 2d, Supplementary Figure 3c-14c
library(SpatialPCA)
set.seed(1234)
...
########################################################################################################################
# PAGA graph in Figure 2e, Supplementary Figure 3c-14c
### 4. run paga in python (dlpfc.py, dlpfc-drsc.py, dlpfc-bayesSpace.py) 



########################################################################################################################
### 5. # RGB plot in Figure 2c, Supplementary Figure 3a-14a
library(BayesSpace)
library(ggplot2)
library(dplyr)
library(ggsci)
